(function () {
    ...
    function input(btn) {
        ...
        console.log('btn: ' + btn);
        console.log('Previous Math Operation: ' + previousMathOperation);
        console.log('Math Operation Counter: ' + mathOperationCount);
    ...
    function handler(btn) {
        ...
        if (!isNaN(btn) || btn === '.') {
            ...
            if (isNaN(btn) && (!isNaN(previousButton)) &&
                btn !== '=' && btn !== 'C' && btn !== 'CE' && btn !== 'CS' && btn !== '.') {
                mathOperationCount++;
            }

            if (mathOperationCount >= 2 && (!isNaN(previousButton)) && btn !== 'CE' && btn !== 'CS') {
